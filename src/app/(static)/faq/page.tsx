    ...
    <div className="max-w-screen min-h-screen  mx-auto overflow-x-hidden w-full h-full">
      <div className="mx-auto p-4 overflow-x-hidden mt-16">
        <h1 className="md:text-5xl text-3xl text-center">
          Have <HighlightText text="Questions?" /> We’ve Got Answers
        </h1>
        <p className="text-base md:text-lg text-center hidden md:block">
          From planning your trip to making the most of every adventure, find
          clear answers to all your queries. Your journey starts here.
        </p>
      </div>
        ...
        <div className="max-h-[80vh] overflow-y-auto md:space-y-4 space-y-2 no-scrollbar md:p-4 p-2 bg-transparent md:rounded-3xl rounded-xl border border-white/20">
          {filteredData.length ? (
            ...
            <div className="text-center text-sm opacity-70 md:mt-10">
              ...
              <p className="w-9/12 md:w-full mx-auto">
                {" "}
                Reach us with your query from &nbsp;
                <Link
                  href="/contact-us"
