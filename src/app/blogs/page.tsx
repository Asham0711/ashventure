            ...
            {!isLoading && blogs.length !== 0 && (
                <div>
                    <div className="lg:w-9/12 w-11/12 mx-auto mt-16 md:mt-24 flex flex-col justify-center items-center gap-4">
                        <h1 className="text-3xl lg:text-5xl text-center">Explore Curated <HighlightText text="Travel Experiences"/></h1>
                        <p className="text-base md:text-xl text-center hidden md:block">
                            Dive into thoughtfully crafted travel blogs featuring diverse travel styles, and honest ratings from real experiences. 
                            Whether you&apos;re planning an adventurous trip with friends, or a romantic escape, 
                            explore stories that help you create unforgettable memories.
                        </p>
                    </div>
