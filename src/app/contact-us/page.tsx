  ...
  return (
    <div className="max-w-screen min-h-screen  mx-auto overflow-x-hidden w-full h-full">
      <div className="lg:w-9/12 w-11/12 mx-auto mt-16 md:mt-24 flex flex-col justify-center items-center gap-4">
        <h1 className="text-3xl lg:text-5xl text-center md:block">
          Let’s Make Your <br /> <HighlightText text="Journey Unforgettable" />{" "}
          Reach Out to Us!
        </h1>
        <p className="text-base md:text-xl text-center hidden md:block">
          We’re here to help you plan, customize, and perfect your travel
          experience. Got an Issue? We’re here for you. Let us know
        </p>
      </div>
