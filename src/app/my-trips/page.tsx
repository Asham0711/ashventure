...
export default function MyTripsPage() {
  ...
  return (
    <div className="max-w-screen min-h-screen  mx-auto overflow-x-hidden w-full h-full">
      {loading && <Loader text="Loading your adventures..." fullPage />}
        ...
        <div>
          <div className="lg:w-9/12 w-11/12 mx-auto mt-16 md:mt-24 flex flex-col justify-center items-center gap-4">
            <h1 className="text-3xl lg:text-5xl text-center">
              Your <HighlightText text="Travel Stories," /> All in One Place
            </h1>
            <p className="text-base md:text-xl text-center hidden md:block">
              Every trip you’ve planned lives here, beautifully organized in one
              place. Open any journey to revisit its detailed itinerary, and
              review all your travel plans—ready to inspire you whenever
              wanderlust strikes or your next adventure calls.
            </p>
          </div>
