...
const MissionSection = () => {
  return (
    <div className="max-w-screen  mx-auto p-4 overflow-x-hidden md:mt-16">
      {/* Feature header */}
      ...
      <h1 className="text-center text-sm md:text-2xl md:mt-6 mt-4">
        <HighlightText text="Core Values" />
      </h1>
