...
const SignupForm = () => {
    ...
    return (
        <div className="bg-transparent backdrop-blur-sm border-white/20 border px-4 py-6 rounded-3xl shadow-lg shadow-black/50 lg:w-[40%] md:w-[50%] w-[95%]">
            <div>
                <p className="md:text-4xl text-3xl text-center"><HighlightText text="Welcome to Ashventure"/></p>
                <p className="text-center w-9/11 md:w-full mx-auto mb-2">Join the millions creating their Itenarary for the next trip</p>
            </div>
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel className='md:text-lg'>First Name</FormLabel>
                                    <Input {...field} name="name" placeholder="Enter your first name" className='bg-black/20 border border-white/50'/>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel className='md:text-lg'>Last Name</FormLabel>
                                    <Input {...field} name="phone" placeholder="Enter your last name" className='bg-black/20 border border-white/50'/>
                                    <FormMessage className="text-red-500 text-sm font-bold"/>
                                </FormItem>
                            )}
                        />
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <Input {...field} name="email" placeholder="Enter your email address" className='bg-black/20 border border-white/50'/>
                                    <FormMessage className="text-red-500 text-sm font-bold"/>
                                </FormItem>
                            )}
                        />
