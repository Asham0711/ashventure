    ...
    <div className="bg-transparent backdrop-blur-sm border-white/20 border px-4 py-6 rounded-3xl shadow-lg shadow-black/50 lg:w-[40%] md:w-[50%] w-[95%]">
      <div>
        <p className="md:text-4xl text-2xl text-center">
          <HighlightText text="Welcome to Ashventure" />
        </p>
        <p className="text-center w-9/11 md:w-full mx-auto mb-2">
          Join the millions creating their Itinerary for the next trips
        </p>
      </div>
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
          ...
          <Button
            type="submit"
            className="w-full rounded-lg text-lg cursor-pointer"
      ...
      <div className="text-center mt-4">
        <p>
          ...
          <Link
            href="/sign-in"
            className="text-primary-brand hover:text-primary-brand-hover"
          >
            Sign In
          </Link>
        </p>
